...
//
//	mockgen -source=internal/repository/article/article_reader.go -package=articlerepomock -destination=internal/repository/article/mocks/article_reader.mock.go
//
